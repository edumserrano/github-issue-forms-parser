namespace GitHubIssuesParserCli
{
    ...
    internal record GitHubIssueFormText(
        string Id,
        string Text) : GitHubIssueFormItem(Id, GitHubIssueFormItemTypes.Text);

    internal record GitHubIssueFormCheckboxes(
        string Id,
        List<GitHubIssueFormCheckboxOption> Options) : GitHubIssueFormItem(Id, GitHubIssueFormItemTypes.Checkboxes);
